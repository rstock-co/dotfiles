(function () {
  ...
  const initNeonDreams = (disableGlow, obs) => {
    ...
    if (!disableGlow) {
      ...
      /* replace neon pink (original === #f92aad) (my edit === #fc5daa)*/
      updatedThemeStyles = updatedThemeStyles.replace(/color: #ff7edb;/gi, "color: #fc5daa; text-shadow: 0 0 2px #100c0f, 0 0 5px #dc078e33, 0 0 10px #fff3; backface-visibility: hidden;");
